...
const ScoreModal = ({
	...
	return (
		// <Modal animationType="slide" transparent={false} visible={isVisible} style={{backgroundColor: 'red', width: 400, height: 400}}>
				...
				{!time ? (
					...
					<>
						...
						>
							...
							>
								{parseFloat(score).toFixed(0)}pts
							</Text>
						</View>
						<View
							style={{
						...
						>
							<View>
								...
								>
									{parseFloat(total_score).toFixed(0)}pts
								</Text>
							</View>
							<Button
								style={{
